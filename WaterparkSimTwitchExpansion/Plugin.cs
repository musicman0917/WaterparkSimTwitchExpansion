...
namespace WaterparkSimTwitchExpansion
{
    ...
    public sealed class Plugin : BasePlugin
    {
        ...
        private void BindConfig()
        {
            ...
            _extraLifeCentsToPointsRatio = Config.Bind("ExtraLife", "CentsToPointsRatio", 2, "Points awarded per CENT donated (2 = 2 points per cent, i.e. 200 points per dollar - double BitsToPointsRatio's 1:1, as a bigger incentive to donate).");
